        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (input.getText().isBlank()) {
                ...
                if (query.cariIntegerSmc("select count(*) from pasien where no_peserta = ?", input.getText()) == 1) {
                    form.tampilKunjunganBedaPoli(input.getText());
                } else if (query.cariIntegerSmc("select count(*) from pasien where no_rkm_medis = ?", input.getText()) == 1) {
                    form.tampilKunjunganBedaPoli(query.cariIsiSmc("select no_peserta from pasien where no_rkm_medis = ?", input.getText()));
                } else if (query.cariInteger("select count(*) from pasien where no_ktp = ?", input.getText()) == 1) {
                    form.tampilKunjunganBedaPoli(query.cariIsiSmc("select no_peserta from pasien where no_ktp = ?", input.getText()));
                } else {
